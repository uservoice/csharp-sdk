...
namespace UserVoiceSdk.Client
{
    ...
    public class Configuration
    {
        ...
        /// <returns></returns>
        public void setApiClientUsingDefault (ApiClient apiClient)
        {
		...
		/// <summary>
		/// Gets ot sets the client secret for authentication.
		/// </summary>
        ...
        {
            String report = "C# SDK (UserVoiceSdk) Debug Report:\n";
