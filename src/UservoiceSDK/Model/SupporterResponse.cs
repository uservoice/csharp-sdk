...
namespace UservoiceSDK.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class SupporterResponse :  IEquatable<SupporterResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SupporterResponse" /> class.
        /// </summary>
        /// <param name="Suggestions">Suggestions.</param>
        /// <param name="Supporters">Supporters.</param>
        /// <param name="Users">Users.</param>
        public SupporterResponse(List<Suggestion> Suggestions = null, List<Supporter> Supporters = null, List<User> Users = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SupporterResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SupporterResponse);
        }

        /// <summary>
        /// Returns true if SupporterResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of SupporterResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SupporterResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
