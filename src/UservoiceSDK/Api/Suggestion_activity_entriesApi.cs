...
namespace UserVoiceSdk.Api
{
    ...
    /// </summary>
    public interface ISuggestion_activity_entriesApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Suggestion_activity_entriesApi : ISuggestion_activity_entriesApi
    {
        private UserVoiceSdk.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        public Suggestion_activity_entriesApi(ApiClient client) 
		{ 
			this.Client = client;
