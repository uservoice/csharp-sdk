...
{
    /// <summary>
    /// ForumInvitationResponsePaginated
    /// </summary>
    [DataContract]
    public partial class ForumInvitationResponsePaginated :  IEquatable<ForumInvitationResponsePaginated>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumInvitationResponsePaginated" /> class.
        /// </summary>
        /// <param name="ForumInvitations">ForumInvitations.</param>
        /// <param name="Forums">Forums.</param>
        /// <param name="Users">Users.</param>
        /// <param name="Pagination">Pagination.</param>
        public ForumInvitationResponsePaginated(List<ForumInvitation> ForumInvitations = null, List<Forum> Forums = null, List<User> Users = null, Pagination Pagination = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForumInvitationResponsePaginated {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ForumInvitationResponsePaginated);
        }

        /// <summary>
        /// Returns true if ForumInvitationResponsePaginated instances are equal
        /// </summary>
        /// <param name="other">Instance of ForumInvitationResponsePaginated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumInvitationResponsePaginated other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
