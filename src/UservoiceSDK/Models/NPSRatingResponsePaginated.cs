...
{
    /// <summary>
    /// NPSRatingResponsePaginated
    /// </summary>
    [DataContract]
    public partial class NPSRatingResponsePaginated :  IEquatable<NPSRatingResponsePaginated>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NPSRatingResponsePaginated" /> class.
        /// </summary>
        /// <param name="NpsRatings">NpsRatings.</param>
        /// <param name="Tickets">Tickets.</param>
        /// <param name="Users">Users.</param>
        /// <param name="Pagination">Pagination.</param>
        public NPSRatingResponsePaginated(List<NPSRating> NpsRatings = null, List<Ticket> Tickets = null, List<User> Users = null, Pagination Pagination = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NPSRatingResponsePaginated {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as NPSRatingResponsePaginated);
        }

        /// <summary>
        /// Returns true if NPSRatingResponsePaginated instances are equal
        /// </summary>
        /// <param name="other">Instance of NPSRatingResponsePaginated to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NPSRatingResponsePaginated other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
