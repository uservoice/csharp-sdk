...
namespace UserVoiceSdk.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class Request42 :  IEquatable<Request42>, IValidatableObject
    {
        /// <summary>
        ...
        public Request42(string AttachmentTokens = null, string Body = null, BodyMimeTypeEnum? BodyMimeType = null, List<IncludesEnum> Includes = null, AdminsuggestionsLinks Links = null, string Title = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Request42);
        }

        /// <summary>
        /// Returns true if Request42 instances are equal
        /// </summary>
        /// <param name="other">Instance of Request42 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Request42 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
