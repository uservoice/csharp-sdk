...
namespace UserVoiceSdk.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class Request38 :  IEquatable<Request38>, IValidatableObject
    {
        ...
        public Request38(string Body = null, List<IncludesEnum> Includes = null)
        {
            this.Body = Body;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Request38);
        }

        /// <summary>
        /// Returns true if Request38 instances are equal
        /// </summary>
        /// <param name="other">Instance of Request38 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Request38 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
