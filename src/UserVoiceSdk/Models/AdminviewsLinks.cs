...
namespace UserVoiceSdk.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdminviewsLinks :  IEquatable<AdminviewsLinks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdminviewsLinks" /> class.
        /// </summary>
        /// <param name="SmartvoteExperiment">SmartvoteExperiment.</param>
        /// <param name="Suggestion">Suggestion.</param>
        /// <param name="User">User.</param>
        public AdminviewsLinks(long? SmartvoteExperiment = null, long? Suggestion = null, long? User = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdminviewsLinks {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AdminviewsLinks);
        }

        /// <summary>
        /// Returns true if AdminviewsLinks instances are equal
        /// </summary>
        /// <param name="other">Instance of AdminviewsLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdminviewsLinks other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
